<?php
    ...
    $name = "<div class='neuL'><span>".$row['firstname']." ".$row['middlename'][0].". ".$row['lastname']."</span></div>";
    $repbug = "<div class='neuL'><span>".$row['repbug']."</span></div>";
    $resbug = "<div class='neuL'><span>".$row['resbug']."</span></div>";
    $inprogbug = "<div class='neuL'><span>".$row['rspdngbug']."</span></div>";
